package extraction;
	...
	public class Extraction2018 {
			...
			public static void main(String[] args) throws SecurityException, ClassNotFoundException, IOException, IllegalArgumentException, IllegalAccessException {
				...
				dFile.setEntityList(listeComplete);//concreteClassList(listeDesClassesInterfaces));
				createFileFromList("/auto_home/pmissechanab/Master-S3/evolution/tp2/Concrete2018.rfct", dFile.getEntityList());
				
				
				/* Create table for concrete classes signatures*/
				// cette table servira de fichier ld'entree pour un outil dans un prochain TP
				...
				d4.setEntityList(listeComplete/*classesConcretesAbstraites*/);
				d4.setCharacteristicList(signatureSet(d4.getEntityList()));
				d4.createTable(2);
				d4.afficheTable();
				d4.ecrireTable("/auto_home/pmissechanab/Master-S3/evolution/tp2/formatConc2018.rcft");
				d4.ecrireTable("/auto_home/pmissechanab/Master-S3/evolution/tp2/formatConc2018.csv");}
		}