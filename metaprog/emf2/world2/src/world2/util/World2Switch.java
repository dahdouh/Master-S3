 ...
 * @generated
 */
public class World2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static World2Package modelPackage;
	...
	public World2Switch() {
		if (modelPackage == null) {
			modelPackage = World2Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case World2Package.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case World2Package.VOITURE: {
