...
import org.eclipse.emf.ecore.impl.MemoClassImpl;
...
public class World2PackageImpl extends EPackageImpl implements World2Package {
	...
	/**
	 * s an instance of the model <b>Package</b>, registered with
	...
	public void createPackageContents() {
		...
		((MemoClassImpl)personEClass).setClassifierID(PERSON);
		getEClassifiers().add(personEClass);

		voitureEClass = ecoreFactory.eINSTANCE.createMemoClass();
		((MemoClassImpl)voitureEClass).setClassifierID(VOITURE);
		getEClassifiers().add(voitureEClass);
