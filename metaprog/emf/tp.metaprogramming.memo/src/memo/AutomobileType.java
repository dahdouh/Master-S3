 ...
 * <!-- end-user-doc -->
 * @see memo.MemoPackage#getAutomobileType()
 * @model
 * @generated
 */
public enum AutomobileType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final AutomobileType[] VALUES_ARRAY =
		new AutomobileType[] {
			BMW,
			MERCEDES,
			AUDI,
	...
	public static AutomobileType get(int value) {
		switch (value) {
			...
			case MERCEDES_VALUE: return MERCEDES;
			case AUDI_VALUE: return AUDI;
			case CITROEN_VALUE: return CITROEN;
