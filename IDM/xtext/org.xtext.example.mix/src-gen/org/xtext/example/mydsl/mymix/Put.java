...
public interface Put extends EObject
{
   ...
   * @see org.xtext.example.mydsl.mymix.MymixPackage#getPut_Quantity()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.mymix.Put#getQuantity <em>Quantity</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setCup(Cup)
   * @see org.xtext.example.mydsl.mymix.MymixPackage#getPut_Cup()
   * @model containment="true"
   * @generated
   */
  Cup getCup();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.mymix.Put#getCup <em>Cup</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.mymix.MymixPackage#getPut_Filter()
   * @model containment="true"
   * @generated
   */
  Filter getFilter();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.mymix.Put#getFilter <em>Filter</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
