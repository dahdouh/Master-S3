 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.mymix.Result#getCup <em>Cup</em>}</li>
 * </ul>
 *
 * @see org.xtext.example.mydsl.mymix.MymixPackage#getResult()
 * @model
 * @generated
 */
public interface Result extends EObject
{
   ...
   * @see #setCup(Cup)
   * @see org.xtext.example.mydsl.mymix.MymixPackage#getResult_Cup()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.mymix.Result#getCup <em>Cup</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
